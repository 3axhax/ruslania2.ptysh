...
You may also pay for Your order to Ruslania's bank account. You will find the necessary banking information on the page of the payment. Also, payments in USD checks are accepted. Check payments in other currencies than USD are not accepted. If You pay by credit or debit card, use electronic banking services or pay with USD check, the order will be shipped immediately after we receive the verification of payment. Both corporate clients and individuals may be invoiced. Finnish customers will receive an invoice along with the ordered goods (inside the package). In case of a non-Finnish customer, Ruslania retains the right to request an advance payment. In this case we will first send an invoice in attachment of an e-mail message in PDF-format. The order will be shipped as soon as the payment has been registered on our bank account (if the ordered titles are in stock). In international payments we recommend using the <A class="maintxt23" HREF="http://www.ruslania.com/download/HTML/IBAN-ENG.htm" target="new">IBAN-number (International Bank Account Number)</A> in order to minimize the extra banking fees. We reserve the right to request an advance payment from Finnish customers according to our consideration. <br>
<br>
