...
class YiiDebugToolbarRoute extends CLogRoute
{
    ...
    public $enableOnlyByCookie = false;
    public $cookieName = 'YiiDebug';
    ...
    public function init()
    {
        ...
        if($this->enableOnlyByCookie && $this->allowIp(Yii::app()->request->userHostAddress))
        {
            $this->enabled = false;
            if(isset($_COOKIE['YiiDebug']))
                $this->enabled = true;
            if(Yii::app()->request->isAjaxRequest) $this->enabled = false;
        }
