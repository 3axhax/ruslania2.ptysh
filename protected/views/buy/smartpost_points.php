...
<div class="row_smartpost">
    <div style="float: right;" class="smartpost_action">
        <a href="javascript:;" class="btn btn-success" onclick="select_smartpost_row(this, '<?= $ui->item('A_NEW_FILTER_SELECT') ?>', '<?= htmlspecialchars(addslashes($desc[$p['id']])) ?>');"><?= $ui->item('CHOOSE') ?></a>
    </div>
