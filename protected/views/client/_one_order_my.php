...
<!--                        --><?//=$ui->item("MSG_PERSONAL_PAYMENT_INSHOP_COMMENTS"); ?>
                ...
                <div class="mbt10 info_order">
					...
					<?=CommonHelper::FormatDeliveryType($order['delivery_type_id']); endif; ?></div></div>
                    ...
                    <tr class="footer">
						...
						<td colspan="4">
							<div class="summa">
								...
								<a style="float: left; margin-right: 10px;" href="<?=Yii::app()->createUrl('client/printorder', array('oid' => $order['id'])); ?>" class="maintxt printed_btn"
