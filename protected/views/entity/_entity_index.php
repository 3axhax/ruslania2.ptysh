...
<div class="news_box nb<?= $entity ?>">
    <div class="container">
        <div class="title">
            <?= ($entity == 30) ? $ui->item("A_NEW_RECOMMENDATIONS_CATEGORY") : $ui->item("A_NEW_NEW_CATEGORY"); ?> <a href="<?= $eUrl; ?>" id="enity<?= $entity ?>"><span class="title__bold"><?= Entity::GetTitle($entity); ?></span></a>
            <div class="pult">
