...
Уважаемый пользователь! <br>На сайт https://www.ruslania.com поступил запрос о восстановлении пароля. В соответствии с этим запросом высылаем Вам Ваш пароль по e-mail адресу, указанному Вами при регистрации.<br><br>Ваш логин: <?=$login; ?><br>Ваш пароль: <?=$pwd; ?>
...
Uvazhaemyj polzovatel! <br>Na sajt https://www.ruslania.com postupil zapros o vosstanovlenii parolja. V sootvetstvii s etim zaprosom vysylaem Vam Vash parol po e-mail adresu, ukazannomu Vami pri registratsii.<br><br>Vash login: <?=$login; ?><br>Vash parol: <?=$pwd; ?>

<!-- Deutsche -->
<? elseif (Yii::app()->language == 'de') : ?>
Sehr geehrter Kunde! <br>Bei https://www.ruslania.com wurde Ihr  Wunsch angenommen, Ihr Kennwort zu liefern. Wir schicken das Kennwort an die von Ihnen bei Anmeldung angegebene E-Mail-Adresse. <br><br>Login: <?=$login; ?><br>Password: <?=$pwd; ?>
...
Arvoisa asiakas! <br>Nettikauppaamme https://www.ruslania.com on saapunut pyynto toimittaa salasana. Lahetamme salasanan sahkopostiosoitteeseen, jonka olet antanut rekisteroityessasi.<br><br>Login: <?=$login; ?><br>Password: <?=$pwd; ?>
...
<br><br>
<a href="https://www.ruslania.com<?= $urlRestore ?>">new password</a>
