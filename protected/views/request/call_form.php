...
<div><?= Yii::app()->ui->item('regform_firstname') ?></div>
<div>
...
<div><?= Yii::app()->ui->item('CODE_COUNTRY') ?></div>
<div><?= Yii::app()->ui->item('NUMBER_PHONE') ?></div>
<div class="clearBoth"></div>
<div><input type="text" value="" name="Send_calls[code]" placeholder="<?= Yii::app()->ui->item('PLACEHOLDER_PHONE') ?>"></div>
<div>
	<?= $form->textField($model, 'face', array('placeholder'=>Yii::app()->ui->item('regform_firstname'))); ?>
