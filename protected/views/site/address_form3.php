...
?>
    ...
    <div class="span7" style="margin-left: 0;">
        ...
        if (count($addr_list)) {
            ...
            echo '<label style="font-weight: bold;">Выберите адрес доставки</label><select name="id_address" style="margin-bottom: 0;margin-right: 8px;" onchange="checked_sogl()">'.((count($addr_list) > 1) ? '<option value="">Выберите адрес доставки</option>' : '' );
            ...
            echo '<label style="font-weight: bold;">Добавьте адрес доставки</label><select name="id_address" style="margin-bottom: 0;margin-right: 8px;" onchange="checked_sogl()"><option value="">Добавьте адрес доставки</option>';
        ...
        if (count($addr_list)) {
            ...
            echo '<label style="font-weight: bold;">Выберите адрес плательщика</label><select name="id_address_b" style="margin-bottom: 0;margin-right: 8px;" onchange="checked_sogl()">'.((count($addr_list) > 1) ? '<option value="">Выберите адрес плательщика</option>' : '' );
            ...
            echo '<label style="font-weight: bold;">Добавьте адрес плательщика</label><select name="id_address_b" style="margin-bottom: 0;margin-right: 8px;" onchange="checked_sogl()"><option value="">Добавьте адрес плательщика</option>';
